(async () => {
    ...
    async function fetchCommandes() {
        try {
            ...
            const container = document.getElementById("commandes-container") || document.getElementById("commandes-list");
            if (container) {
    ...
    function afficherCommandes(commandes) {
        const wrapper = document.getElementById("commandes-container") || document.getElementById("commandes-list");
        if (!wrapper) return;
        ...
        commandes.forEach(cmd => {
            ...
            const total = (parseFloat(cmd.prix_menu || 0) + parseFloat(cmd.prix_livraison || 0)).toFixed(2);
            ...
            wrapper.insertAdjacentHTML("beforeend", `
                <div class="commande-card mb-3 p-3 text-white bg-dark rounded border border-secondary">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <h5 class="mb-0 badge bg-secondary">Total : ${total} €</h5>
                    </div>
                </div>
            `);
        });
